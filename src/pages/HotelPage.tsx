          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              <motion.div variants={fadeInUp} className="col-span-2 aspect-[16/9] overflow-hidden">
                <img src={`/images/${hotel.id}-room.jpg`} alt="Room" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" onError={(e) => { e.currentTarget.src = '/images/gallery-room-1.jpg' }} />
              </motion.div>
              <motion.div variants={fadeInUp} className="aspect-square overflow-hidden">
                <img src={`/images/${hotel.id}-lobby.jpg`} alt="Lobby" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" onError={(e) => { e.currentTarget.src = '/images/gallery-lobby-1.jpg' }} />
              </motion.div>
              <motion.div variants={fadeInUp} className="aspect-square overflow-hidden">
                <img src={`/images/${hotel.id}-bath.jpg`} alt="Bathroom" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" onError={(e) => { e.currentTarget.src = '/images/gallery-bath-1.jpg' }} />
              </motion.div>
            </motion.div>
          </div>
        </div>
